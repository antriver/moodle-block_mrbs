...
$string['allowed_cohorts'] = 'Cohorts allowed to book:<br/>(Select none to allow all)';
$string['area_admin_email']   = 'Area admin email';
$string['area']              = 'Area';
$string['areas']              = 'Areas';
$string['backadmin']          = 'Back to Admin';
$string['bgcolor']            = 'bgcolor';
$string['blockname'] = 'Facilities Booking System';
...
$string['ctrl_click_type']    = 'Use Control-Click to select more than one.';
$string['ctrl_click']         = 'Use Control-Click to select more than one.';
$string['custom.num_passengers'] = 'Number Of Passengers';
$string['custom.destination'] = 'Destination';
...
$string['dontshowoccupied']   = 'Hide unavailable';
...
$string['editroomarea']       = 'Edit Area / Room';
...
$string['fulldescription']    = 'Reason For Booking';
$string['fulldescription_desc'] = '(Number of people, Internal/External etc)';
$string['fulldescription_desc.tennis_courts'] = '(List the names of all participants<br/>and your mobile phone number.)';
$string['goroom']             = 'Go';
$string['goto']               = 'Go';
...
$string['index_heading'] = 'Select An Area To Book';
$string['in']                 = 'in';
...
$string['mrbs']               = 'Facilities Booking System';
...
$string['no_rooms_for_area']  = 'There are no rooms defined for this area.';
...
$string['room']               = 'Room';
$string['room.vehicles'] = 'Vehicle';
$string['room.tennis_courts'] = 'Court';
