...
$string['blockname'] = 'Facility Booking';
...
$string['ctrl_click_type']    = 'Use Control + Click (Command + Click on Mac) to select more than one type';
$string['ctrl_click']         = 'Use Control + Click (Command + Click on Mac) to select more than one room';
$string['ctrl_click_vehicle'] = 'Use Control + Click (Command + Click on Mac) to select more than one vehicle';
